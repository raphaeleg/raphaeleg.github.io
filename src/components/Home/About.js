    ...
    return (
        <div className="flex flex-col lg:flex-row items-start align-start relative w-full py-12 lg:min-h-[35vh]">
            <span className="flex flex-col items-start justify-center px-16 relative h-full sm:w-full lg:w-[70vw]">
                ...
                <p className='sm:inline-block mt-4 md:text-lg lg:text-xl font-in font-light'>Looking forward to working on a game title with strong world-building and RPG elements based in the UK 🇬🇧, Canada 🇨🇦, or Sweden 🇸🇪. Currently based in Hong Kong 🇭🇰</p>
